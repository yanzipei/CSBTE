...
public:
	...
	bool AddFile(const char *fileName, const char *pPathID);
...
{
	return AddFile(g_pFullFileSystem, szFileName);
}

bool CLocalizedStringTable::AddFile(const char *szFileName, const char *pPathID)
{
	return AddFile(g_pFullFileSystem, szFileName, pPathID);
}
...
bool CLocalizedStringTable::AddFile(IFileSystem *fileSystem, const char *szFileName, const char *pPathID)
{
	...
	if (langptr)
	{
		...
		success = AddFile(fileName, pPathID);
