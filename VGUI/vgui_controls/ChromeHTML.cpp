...
// Purpose: data accessor
//-----------------------------------------------------------------------------
void ChromeHTML::SetViewSourceEnabled(bool state)
{
...
void ChromeHTML::BrowserFileLoadDialog( )
{
	...
	if ( surface()->OpenOSFileOpenDialog( title, pCmd->initialfile().c_str(), NULL, rgchFileName, sizeof(rgchFileName) ) )
	{
	...
	else*/
	{
		...
		m_hFileOpenDialog = new FileOpenDialog( this, title, true );
