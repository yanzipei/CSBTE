...
//
// Purpose: Creates a ChromeHTML control
//
// $NoKeywords: $
//=============================================================================//
...
//-----------------------------------------------------------------------------
// Purpose: Control to display ChromeHTML content
//			This control utilises a hidden IE window to render a ChromeHTML page for you.
...
//-----------------------------------------------------------------------------
class ChromeHTML: public Panel, public IHTMLResponses_HL1
{
	DECLARE_CLASS_SIMPLE( ChromeHTML, Panel );
	// TODO::STYLE
	//DECLARE_STYLE_BASE( "ChromeHTML" );
public:

	ChromeHTML(Panel *parent,const char *name, bool allowJavaScript = false, bool bPopupWindow = false);
	~ChromeHTML();
	...
	*/
	...
	void PaintComboBox();
	int  BrowserGetIndex() { return m_pSerializer->BrowserGetIndex(); }

private:
	IHTMLChromeController *m_pController;
...
private:
	...
	public:
		CHTMLFindBar( ChromeHTML *parent );
