...
CDialogGameInfo::CDialogGameInfo(vgui::Panel *parent, serveritem_t &server) : Frame(parent, "DialogGameInfo"), m_Servers(this), m_GetChallenge(this), m_PlayerInfo(this)
{
	...
	LoadControlSettingsFromScheme("Servers/DialogGameInfo.res");
	RegisterControlSettingsFileEx("Servers/DialogGameInfo_SinglePlayer.res");
	RegisterControlSettingsFileEx("Servers/DialogGameInfo_AutoRetry.res");
}
...
void CDialogGameInfo::ShowAutoRetryOptions(bool state)
{
	...
	if (state)
		LoadControlSettingsFromScheme("Servers/DialogGameInfo_AutoRetry.res");
	else
		LoadControlSettingsFromScheme("Servers/DialogGameInfo.res");
